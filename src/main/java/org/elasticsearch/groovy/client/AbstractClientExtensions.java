...
abstract class AbstractClientExtensions {
     ...
     */
    protected static
        <Request extends ActionRequest, Response extends ActionResponse, Client extends ElasticsearchClient<Client>>
        Wrapper<Request, Response> wrap(Client client, Request request) {
        return new Wrapper<>(client, request);
    }
     ...
     * @throws NullPointerException if any parameter is {@code null}
     */
    @SuppressWarnings("unchecked") // <- Closure
    protected static
        <Request extends ActionRequest, Response extends ActionResponse, Client extends ElasticsearchClient<Client>>
        Wrapper<Request, Response> wrap(Client client, Request request, Closure requestClosure) {
        // configure the request
        DefaultGroovyMethods.with(request, requestClosure);

        return wrap(client, request);
    }
     ...
     */
    protected static class Wrapper<Request extends ActionRequest, Response extends ActionResponse> {
        /**
         ...
         */
        public final PlainListenableActionFuture<Response> responseFuture;
         ...
         * @throws NullPointerException if any parameter is {@code null}
         */
        public <Client extends ElasticsearchClient<Client>> Wrapper(Client client, Request request) {
            // required
