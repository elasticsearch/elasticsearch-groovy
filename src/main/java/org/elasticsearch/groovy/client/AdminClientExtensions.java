 ...
 * @see Client#admin()
 */
public class AdminClientExtensions {
     ...
     */
    public static ClusterAdminClient getCluster(AdminClient self) {
        return self.cluster();
    }
     ...
     */
    public static IndicesAdminClient getIndices(AdminClient self) {
        return self.indices();
    }
}
