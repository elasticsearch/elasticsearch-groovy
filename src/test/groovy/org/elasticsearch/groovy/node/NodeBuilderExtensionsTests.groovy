 ...
 */
class NodeBuilderExtensionsTests extends RandomizedTest {
    /**
     * Mock {@link NodeBuilder} to ensure functionality.
     */
    private final NodeBuilder builder = mock(NodeBuilder)
